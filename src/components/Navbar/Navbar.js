      ...
      <nav className="navbar navbar-expand-md navbar-light bg-light">
        ...
        <div className="collapse navbar-collapse bg-light" id="navbarSupportedContent">
          <form className="form-inline my-2 my-lg-0">
            <input className="form-control form-control-sm mr-sm-2 form-search-input"  type="search" placeholder="Search" aria-label="Search" />
            <button className="btn btn-outline-secondary btn-sm my-2 my-sm-0 form-search-button" type="submit">Search</button>
          </form>
          <ul className="navbar-nav ml-auto">
            <li className="nav-item my-auto  nav-item-profile">
              <div className="nav-link  wrap-name-status">
                <a className="nav-item-name" href="/me" >{name}</a>
                <span className="nav-item-status" >{status}</span>
              </div>
            </li>
            <li className="nav-item my-auto nav-item-profile">
              <a className="nav-link" href="/me" >
              <img style={{ objectFit: "cover", height: "32px", width: "32px", borderRadius: "32rem"}} 
              alt=""
              src={picture}/>
              </a>
            </li>
